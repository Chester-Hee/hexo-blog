...
假设：
 - 变量：<img src="http://latex.codecogs.com/gif.latex?\dpi{80}&space;\LARGE&space;a_{i}" title="\LARGE a_{i}" /> 表示第 `i` 个区域的警察数
 - 变量：<img src="http://latex.codecogs.com/gif.latex?\dpi{80}&space;\LARGE&space;b_{i}" title="\LARGE b_{i}" /> 表示第 `i` 个区域的犯罪率
